...
function ink_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous nav-link">%link</div>', _x( '<span class="meta-nav"><i class="fa fa-chevron-left"></i> Previous Post</span>', 'Previous post link', 'stag' ) );
				next_post_link(     '<div class="nav-next nav-link">%link</div>',     _x( '<span class="meta-nav">Next Post <i class="fa fa-chevron-right"></i></span>', 'Next post link', 'stag' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
